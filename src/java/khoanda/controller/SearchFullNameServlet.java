...
public class SearchFullNameServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = properties.getProperty(MyApplicationConstant.SearchFeatures.SEARCH_PAGE);
...
//                else if (url.equals(properties.getProperty(MyApplicationConstant.SearchFeatures.SEARCH_PAGE) + "txtSearchValue=")) {
//                    url = properties.getProperty(MyApplicationConstant.SearchFeatures.SEARCH_PAGE);
//                }
            }
